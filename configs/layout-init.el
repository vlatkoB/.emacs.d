...
(use-package tabbar
  ...
  :init (tabbar-mode t)
    ...
    (defun tabbar-grouping () ;; show all source files in Develop group
      (list (cond
             ((eq major-mode 'css-mode)                            "Development")
             ((eq major-mode 'dhall-mode)                          "Development")
             ...
             ((eq major-mode 'html-mode)                           "Development")
             ((eq major-mode 'mhtml-mode)                          "Development")
             ((eq major-mode 'json-mode)                           "Development")
             ...
             ((eq major-mode 'purescript-mode)                     "Development")
             ((eq major-mode 'scss-mode)                           "Development")
             ...
             ((string-equal "*psc-ide-rebuild*" (buffer-name))     "Fundamental")
             ((string-equal "*haskell-process-log*" (buffer-name)) "Fundamental")
